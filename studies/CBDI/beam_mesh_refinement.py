...
line0, = plt.plot([0,35], [amp,amp],'k-')
line1, = plt.plot(num_divisions, water_volume_1/(S*L*zw),'ko--')
line2, = plt.plot(num_divisions, water_volume_2/(S*L*zw),'ro--')
plt.legend((line0,line1,line2), ('Analytical','$n_{ele} = n_{div}$','$n_{ele} = 1$'),frameon=False)
