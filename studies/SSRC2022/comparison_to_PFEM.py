...
if zj <= 0:
  ...
  disps1 = np.loadtxt(f"disp/disp-{height1}in{time}.txt")
  pfem1, = plt.plot(disps1[:,0],disps1[:,1],'r--',lw=3)
  disps2 = np.loadtxt(f"disp/disp-{height2}in{time}.txt")
  pfem2, = plt.plot(disps2[:,0],disps2[:,1],'g--',lw=3)
  disps3 = np.loadtxt(f"disp/disp-{height3}in{time}.txt")
  pfem3, = plt.plot(disps3[:,0],disps3[:,1],'b--',lw=3)
  plt.legend((line1, line2, line3, pfem1, pfem2, pfem3), (f"{height1} in", f"{height2} in", f"{height3} in", f"PFEM {height1} in", f"PFEM {height2} in", f"PFEM {height3} in"),frameon=False)
else:
  line1, = plt.plot(results_PyPonding_vol1.position_along_length/ft,results_PyPonding_vol1.deflection_along_length/inch,'b-')
  disps1 = np.loadtxt(f"disp/disp-{height1}in-{zj}in{time1}.txt")
  pfem1, = plt.plot(disps1[:,0],disps1[:,1],'b--',lw=3)
  plt.legend((line1, pfem1), (f"{height1} in", f"PFEM {height1} in"),frameon=False)
  # disps2 = np.loadtxt(f"disp/disp-{height2}in-{zj}in{time2}.txt")
  # pfem2, = plt.plot(disps2[:,0],disps2[:,1],'g--',lw=3)
  # disps3 = np.loadtxt(f"disp/disp-{height3}in-{zj}in{time3}.txt")
  # pfem3, = plt.plot(disps3[:,0],disps3[:,1],'b--',lw=3)
  plt.title(f'Sloped Beam: zj = {zj} in')
#plt.legend((line1, line2), ('PyPonding', 'No Ponding Effect'),frameon=False)
...
if zj <= 0:
  ...
  axials1 = np.loadtxt(f"axial/axial-{height1}in{time}.txt")
  pfem1, = plt.plot(axials1[:,0],axials1[:,1],'r--',lw=3)
  axials2 = np.loadtxt(f"axial/axial-{height2}in{time}.txt")
  pfem2, = plt.plot(axials2[:,0],axials2[:,1],'g--',lw=3)
  axials3 = np.loadtxt(f"axial/axial-{height3}in{time}.txt")
  ...
  axials1 = np.loadtxt(f"axial/axial-{height1}in-{zj}in{time1}.txt")
  pfem1, = plt.plot(axials1[:,0],axials1[:,1],'b--',lw=3)
  # axials2 = np.loadtxt(f"axial/axial-{height2}in-{zj}in{time2}.txt")
  # pfem2, = plt.plot(axials2[:,0],axials2[:,1],'g--',lw=3)
  # axials3 = np.loadtxt(f"axial/axial-{height3}in-{zj}in{time3}.txt")
  # pfem3, = plt.plot(axials3[:,0],axials3[:,1],'b--',lw=3)
  plt.title(f'Sloped Beam: zj = {zj} in')
  plt.legend((line1, pfem1), (f"{height1} in", f"PFEM {height1} in"),frameon=False)

#plt.legend((line1, line2), ('PyPonding', 'No Ponding Effect'),frameon=False)
# plt.legend((line1, line2, line3), (f"{height1} in", f"{height2} in", f"{height3} in"),frameon=False)
plt.xlabel('Position Along Length of Beam (ft)')
...
if zj <= 0:
  ...
  shears1 = np.loadtxt(f"shear/shear-{height1}in{time}.txt")
  pfem1, = plt.plot(shears1[:,0],shears1[:,1],'r--',lw=3)
  shears2 = np.loadtxt(f"shear/shear-{height2}in{time}.txt")
  pfem2, = plt.plot(shears2[:,0],shears2[:,1],'g--',lw=3)
  shears3 = np.loadtxt(f"shear/shear-{height3}in{time}.txt")
  ...
  shears1 = np.loadtxt(f"shear/shear-{height1}in-{zj}in{time1}.txt")
  pfem1, = plt.plot(shears1[:,0],shears1[:,1],'b--',lw=3)
  # shears2 = np.loadtxt(f"shear/shear-{height2}in-{zj}in{time2}.txt")
  # pfem2, = plt.plot(shears2[:,0],shears2[:,1],'g--',lw=3)
  # shears3 = np.loadtxt(f"shear/shear-{height3}in-{zj}in{time3}.txt")
  # pfem3, = plt.plot(shears3[:,0],shears3[:,1],'b--',lw=3)
  plt.title(f'Sloped Beam: zj = {zj} in')
  plt.legend((line1, pfem1), (f"{height1} in", f"PFEM {height1} in"),frameon=False)
...
if zj <= 0:
  ...
  moments1 = np.loadtxt(f"moment/moment-{height1}in{time}.txt")
  pfem1, = plt.plot(moments1[:,0],moments1[:,1],'r--',lw=3)
  # moments2 = np.loadtxt(f"moment/moment-{height2}in{time}.txt")
  # pfem2, = plt.plot(moments2[:,0],moments2[:,1],'g--',lw=3)
  # moments3 = np.loadtxt(f"moment/moment-{height3}in{time}.txt")
  ...
  moments1 = np.loadtxt(f"moment/moment-{height1}in-{zj}in{time1}.txt")
  pfem1, = plt.plot(moments1[:,0],moments1[:,1],'b--',lw=3)
  # moments2 = np.loadtxt(f"moment/moment-{height2}in-{zj}in{time2}.txt")
  # pfem2, = plt.plot(moments2[:,0],moments2[:,1],'g--',lw=3)
  # moments3 = np.loadtxt(f"moment/moment-{height3}in-{zj}in{time3}.txt")
  # pfem3, = plt.plot(moments3[:,0],moments3[:,1],'b--',lw=3)
  plt.title(f'Sloped Beam: zj = {zj} in')
  plt.legend((line1, pfem1), (f"{height1} in", f"PFEM {height1} in"),frameon=False)
