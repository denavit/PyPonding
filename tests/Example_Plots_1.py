...
ax = fig.add_axes([0.18,0.18,0.80,0.78])
...
plt.xlim(0,L/m)
plt.ylim(-100,0)
plt.savefig('Example_Defl_Shape.png',dpi=300)
plt.savefig('Example_Defl_Shape.pdf')
...
plt.xlim(0,L/m)
plt.ylim(0,100)
plt.savefig('Example_Bending_Moment.png',dpi=300)
plt.savefig('Example_Bending_Moment.pdf')
