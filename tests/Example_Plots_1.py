...
# Plot Results
plt.figure(1)  
line2, = plt.plot(x/m,y2/mm, '-')
line3, = plt.plot(x/m,y1/mm, '-')
line1, = plt.plot(x_OPS/m,y_OPS/mm,'o')
plt.legend((line1, line2, line3), ('Numerical Results', 'Closed-form Solution', 'No Ponding Effect'))
plt.xlabel('Position Along Length of Beam (mm)')
...
plt.figure(2)
line2, = plt.plot(x/m,M2/kNm, '-')
line3, = plt.plot(x/m,M1/kNm, '-')
line1, = plt.plot(x_OPS/m,M_OPS/kNm,'o')
plt.legend((line1, line2, line3), ('Numerical Results', 'Closed-form Solution', 'No Ponding Effect'))
plt.xlabel('Position Along Length of Beam (mm)')
